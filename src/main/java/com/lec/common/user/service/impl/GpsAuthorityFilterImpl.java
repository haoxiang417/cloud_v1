 ...
 */
@Service
public class GpsAuthorityFilterImpl extends AbstractAuthorityContext implements GpsAuthorityFilter{
	 ...
	 */
	@Override
	public boolean isGpsModule(String menuid) {
		List<SystemResource> res = getModuleMap().get("gps");
		boolean isGps = false;
	...
	public boolean isEnable(String menuid) {
		return "1".equals(ParamsService.SYSTEM_PARAMS.get("isGps"));
	}
